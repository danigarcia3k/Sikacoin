...
class BIP66Test(SikacoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # sikacoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and sikacoind produces more specific reject
            # reasons.
