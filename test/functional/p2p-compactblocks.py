...
# TestNode: A peer we use to send messages to sikacoind, and store responses.
...
class CompactBlocksTest(SikacoinTestFramework):
    ...
    # This test actually causes sikacoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sikacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sikacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # sikacoind will not send blocktxn responses for blocks whose height is
