...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SikacoinTestFramework
    pass

class ExampleTest(SikacoinTestFramework):
    # Each functional test is a subclass of the SikacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SikacoinTestFramework class so other tests can use it."""
