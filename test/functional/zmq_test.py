...
from test_framework.test_framework import SikacoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (SikacoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that sikacoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("sikacoind has not been built with zmq enabled.")
