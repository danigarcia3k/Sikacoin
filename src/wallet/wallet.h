...
#ifndef SIKACOIN_WALLET_WALLET_H
#define SIKACOIN_WALLET_WALLET_H
...
public:
     ...
     * on this sikacoin node, and set to 0 for transactions that were created
...
#endif // SIKACOIN_WALLET_WALLET_H
