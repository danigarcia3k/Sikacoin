...
#if defined(NDEBUG)
# error "Sikacoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Sikacoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SKC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("sikacoin-scriptch");
