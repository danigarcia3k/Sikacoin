...
#ifndef SIKACOIN_TEST_SCRIPTNUM10_H
#define SIKACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sikacoin Core 0.10.0, for cross-comparison.
 */
public:
