Sikacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/sikacoin/files/Sikacoin/sikacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Sikacoin
...
New/changed settings (command-line or sikacoin.conf file)
--------------------------------------------------------
