Sikacoin Core version 0.9.4 is now available from:

  https://sikacoin.org/bin/0.9.4/
...
this update is incompatible with the Sikacoin system and could lead to consensus
forks.

Sikacoin Core released binaries from https://sikacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~sikacoin/+archive/ubuntu/sikacoin
- A third-party or self-compiled Sikacoin Core

upgrade to Sikacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
