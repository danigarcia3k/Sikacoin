Sikacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/sikacoin/files/Sikacoin/sikacoin-0.5.4/
...
http://gitorious.org/sikacoin/sikacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Sikacoin-Qt notifications under Growl 1.3.
Increase required age of Sikacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSikacoin properly when installing Sikacoin-Qt over it. (Windows)
