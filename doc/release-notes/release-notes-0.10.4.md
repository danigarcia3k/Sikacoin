Sikacoin Core version 0.10.4 is now available from:

  <https://sikacoin.org/bin/sikacoin-core-0.10.4/>
...
- #6953 `43c2789` Split sikacoin-tx into its own package
- #6953 `dfe0d4d` Include sikacoin-tx binary on Debian/Ubuntu
