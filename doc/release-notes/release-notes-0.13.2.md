Sikacoin Core version 0.13.2 is now available from:

  <https://sikacoin.org/bin/sikacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update sikacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow sikacoin-tx to create v2 transactions (skcdrak)
