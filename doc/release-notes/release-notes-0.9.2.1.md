Sikacoin Core version 0.9.2.1 is now available from:

  https://sikacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SKC to 0.01 SKC
...
- Fix "Start sikacoin on system login"
