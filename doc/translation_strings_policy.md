...
This document provides guidelines for internationalization of the Sikacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sikacoin_en.ts` remains unchanged.
